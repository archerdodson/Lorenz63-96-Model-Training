...
#####################################################################
batch_size, ensemble_size, method, nn_model, data_size, auxiliary_var_size = 512, 3, 'SR', 'rnn', 1, 1                                                                       # OR 10          #8/1
shuffletrue = True 
hidden_size_rnn = 8 #32/8
...
args_dict = {}
weight_decay, scheduler_gamma, lr, epochs, early_stopping, epochs_early_stopping_interval = 0, 1, 0.001, 800, True, 20 #Original Learning rate 0.01 

model, scoring_rule = 'lorenz', 'SignatureKernel' #Doesn't matter?
...
datasets_folder = 'results/lorenz/datasets/'  #lorenz96
...
model, scoring_rule = 'lorenz', 'EnergyScore' #Doesn't matter?
cuda, continue_training_net, start_epoch_early_stopping, use_tqdm, method_is_gan  = True, False, 100, True, False
