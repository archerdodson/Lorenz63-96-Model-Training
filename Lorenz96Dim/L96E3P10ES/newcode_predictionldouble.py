...
#####################################################################
batch_size, ensemble_size, method, nn_model, data_size, auxiliary_var_size = 512, 3, 'SR', 'rnn', 8, 1                                                                       # OR 10          #8/1
shuffletrue = True 
hidden_size_rnn = 32 #32/8
...
args_dict = {}
weight_decay, scheduler_gamma, lr, epochs, early_stopping, epochs_early_stopping_interval = 0, 1, 0.001, 1, True, 20 #Original Learning rate 0.01 
...
datasets_folder = 'results/lorenz96/datasets/'  #lorenz96
...
batch_size, ensemble_size, method, nn_model, data_size, auxiliary_var_size = 512, 3, 'SR', 'rnn', 8, 1 #mess around with model size
...
args_dict = {}
weight_decay, scheduler_gamma, lr, epochs, early_stopping, epochs_early_stopping_interval = 0, 1, 0.01, 1000, True, 20 #Original Learning rate 0.01 
